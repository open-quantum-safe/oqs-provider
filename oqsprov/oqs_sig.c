...
const OSSL_DISPATCH oqs_signature_functions[] = {
    ...
    {OSSL_FUNC_SIGNATURE_SIGN_MESSAGE_UPDATE, (void (*)(void))oqs_sig_signverify_message_update},
    ...
    {OSSL_FUNC_SIGNATURE_VERIFY_MESSAGE_UPDATE, (void (*)(void))oqs_sig_signverify_message_update},
