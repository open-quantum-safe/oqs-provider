...
static OQS_GROUP_CONSTANTS oqs_group_list[] = {
    ...
    {65056, 192, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1},
    ...
    {65057, 256, TLS1_3_VERSION, 0, DTLS1_3_VERSION, 0, 1},
...
///// OQS_TEMPLATE_FRAGMENT_GROUP_NAMES_START
    ...
    OQS_GROUP_ENTRY(bp384_mlkem768, bp384_mlkem768, bp384_mlkem768, 22),
    OQS_GROUP_ENTRY(X25519MLKEM768, X25519MLKEM768, X25519MLKEM768, 23),
    OQS_GROUP_ENTRY(SecP256r1MLKEM768, SecP256r1MLKEM768, SecP256r1MLKEM768,
                    24),
#endif
#ifdef OQS_ENABLE_KEM_ml_kem_1024
    OQS_GROUP_ENTRY(mlkem1024, mlkem1024, mlkem1024, 25),

    OQS_GROUP_ENTRY(p521_mlkem1024, p521_mlkem1024, p521_mlkem1024, 26),
    OQS_GROUP_ENTRY(SecP384r1MLKEM1024, SecP384r1MLKEM1024, SecP384r1MLKEM1024,
                    27),
    OQS_GROUP_ENTRY(bp512_mlkem1024, bp512_mlkem1024, bp512_mlkem1024, 28),
#endif
#ifdef OQS_ENABLE_KEM_bike_l1
    OQS_GROUP_ENTRY(bikel1, bikel1, bikel1, 29),

    OQS_GROUP_ENTRY(p256_bikel1, p256_bikel1, p256_bikel1, 30),
    OQS_GROUP_ENTRY(x25519_bikel1, x25519_bikel1, x25519_bikel1, 31),
#endif
#ifdef OQS_ENABLE_KEM_bike_l3
    OQS_GROUP_ENTRY(bikel3, bikel3, bikel3, 32),

    OQS_GROUP_ENTRY(p384_bikel3, p384_bikel3, p384_bikel3, 33),
    OQS_GROUP_ENTRY(x448_bikel3, x448_bikel3, x448_bikel3, 34),
#endif
#ifdef OQS_ENABLE_KEM_bike_l5
    OQS_GROUP_ENTRY(bikel5, bikel5, bikel5, 35),

    OQS_GROUP_ENTRY(p521_bikel5, p521_bikel5, p521_bikel5, 36),
#endif
...
int oqs_patch_codepoints() {
    ...
    if (getenv("OQS_CODEPOINT_MLKEM1024"))
        oqs_group_list[25].group_id = atoi(getenv("OQS_CODEPOINT_MLKEM1024"));
    ...
    if (getenv("OQS_CODEPOINT_BIKEL1"))
        oqs_group_list[29].group_id = atoi(getenv("OQS_CODEPOINT_BIKEL1"));
    if (getenv("OQS_CODEPOINT_P256_BIKEL1"))
        oqs_group_list[30].group_id = atoi(getenv("OQS_CODEPOINT_P256_BIKEL1"));
    ...
    if (getenv("OQS_CODEPOINT_BIKEL3"))
        oqs_group_list[32].group_id = atoi(getenv("OQS_CODEPOINT_BIKEL3"));
    if (getenv("OQS_CODEPOINT_P384_BIKEL3"))
        oqs_group_list[33].group_id = atoi(getenv("OQS_CODEPOINT_P384_BIKEL3"));
    if (getenv("OQS_CODEPOINT_X448_BIKEL3"))
        oqs_group_list[34].group_id = atoi(getenv("OQS_CODEPOINT_X448_BIKEL3"));
    if (getenv("OQS_CODEPOINT_BIKEL5"))
        oqs_group_list[35].group_id = atoi(getenv("OQS_CODEPOINT_BIKEL5"));
    if (getenv("OQS_CODEPOINT_P521_BIKEL5"))
        oqs_group_list[36].group_id = atoi(getenv("OQS_CODEPOINT_P521_BIKEL5"));
