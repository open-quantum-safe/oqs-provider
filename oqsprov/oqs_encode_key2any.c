...
MAKE_ENCODER(dilithium2, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_dilithium2, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_dilithium2, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_dilithium2, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(dilithium3, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p384_dilithium3, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(dilithium5, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p521_dilithium5, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(dilithium2_aes, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_dilithium2_aes, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_dilithium2_aes, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_dilithium2_aes, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(dilithium3_aes, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p384_dilithium3_aes, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(dilithium5_aes, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p521_dilithium5_aes, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(falcon512, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_falcon512, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_falcon512, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_falcon512, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(falcon1024, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p521_falcon1024, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(picnicl1full, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_picnicl1full, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_picnicl1full, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_picnicl1full, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(picnic3l1, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_picnic3l1, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_picnic3l1, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_picnic3l1, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(rainbowIclassic, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_rainbowIclassic, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_rainbowIclassic, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_rainbowIclassic, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(rainbowVclassic, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p521_rainbowVclassic, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(sphincsharaka128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_sphincsharaka128frobust, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_sphincsharaka128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_sphincsharaka128frobust, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(sphincssha256128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_sphincssha256128frobust, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_sphincssha256128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_sphincssha256128frobust, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(sphincsshake256128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(p256_sphincsshake256128frobust, oqsx, EncryptedPrivateKeyInfo, der);
...
MAKE_ENCODER(p256_sphincsshake256128frobust, oqsx, SubjectPublicKeyInfo, pem);MAKE_ENCODER(rsa3072_sphincsshake256128frobust, oqsx, EncryptedPrivateKeyInfo, der);
