...
#    define OQS_KEMOID_CNT 0
    ...
    if (getenv("OQS_OID_DILITHIUM5"))
        oqs_oid_alg_list[26 + OQS_KEMOID_CNT] = getenv("OQS_OID_DILITHIUM5");
    ...
    if (getenv("OQS_OID_FALCON512"))
        oqs_oid_alg_list[30 + OQS_KEMOID_CNT] = getenv("OQS_OID_FALCON512");
    ...
    if (getenv("OQS_OID_FALCON1024"))
        oqs_oid_alg_list[36 + OQS_KEMOID_CNT] = getenv("OQS_OID_FALCON1024");
...
int oqs_patch_encodings(void)
{
    ...
    if (getenv("OQS_ENCODING_DILITHIUM5"))
        oqs_alg_encoding_list[26] = getenv("OQS_ENCODING_DILITHIUM5");
    if (getenv("OQS_ENCODING_DILITHIUM5_ALGNAME"))
        oqs_alg_encoding_list[27] = getenv("OQS_ENCODING_DILITHIUM5_ALGNAME");
    if (getenv("OQS_ENCODING_P521_DILITHIUM5"))
        oqs_alg_encoding_list[28] = getenv("OQS_ENCODING_P521_DILITHIUM5");
    ...
    if (getenv("OQS_ENCODING_FALCON512"))
        oqs_alg_encoding_list[30] = getenv("OQS_ENCODING_FALCON512");
    ...
    if (getenv("OQS_ENCODING_P256_FALCON512"))
        oqs_alg_encoding_list[32] = getenv("OQS_ENCODING_P256_FALCON512");
    ...
    if (getenv("OQS_ENCODING_RSA3072_FALCON512"))
        oqs_alg_encoding_list[34] = getenv("OQS_ENCODING_RSA3072_FALCON512");
    ...
    if (getenv("OQS_ENCODING_FALCON1024"))
        oqs_alg_encoding_list[36] = getenv("OQS_ENCODING_FALCON1024");
    if (getenv("OQS_ENCODING_FALCON1024_ALGNAME"))
        oqs_alg_encoding_list[37] = getenv("OQS_ENCODING_FALCON1024_ALGNAME");
