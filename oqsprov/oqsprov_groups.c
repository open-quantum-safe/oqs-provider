...
///// OQS_TEMPLATE_FRAGMENT_GROUP_ASSIGNMENTS_START
   ...
   { 0x023A, 0x2F3A, 0x2F26, 128, TLS1_3_VERSION, 0, -1, 0, 1 },
   { 0x023C, 0x2F3C, 0x2F50, 192, TLS1_3_VERSION, 0, -1, 0, 1 },
   ...
   { 0x023E, 0x2F3E, 0x2F69, 128, TLS1_3_VERSION, 0, -1, 0, 1 },
   { 0x023F, 0x2F3F, 0x2F6A, 192, TLS1_3_VERSION, 0, -1, 0, 1 },
...
///// OQS_TEMPLATE_FRAGMENT_GROUP_NAMES_START
    ...
    OQS_GROUP_ENTRY(ntru_hrss701, ntru_hrss701, ntru_hrss701, 192, 12),
    OQS_GROUP_ENTRY_ECP(ntru_hrss701, ntru_hrss701, ntru_hrss701, 192, 12),
    OQS_GROUP_ENTRY_ECX(ntru_hrss701, ntru_hrss701, ntru_hrss701, 192, 12),
    OQS_GROUP_ENTRY(lightsaber, lightsaber, lightsaber, 128, 13),
    OQS_GROUP_ENTRY_ECP(lightsaber, lightsaber, lightsaber, 128, 13),
    OQS_GROUP_ENTRY_ECX(lightsaber, lightsaber, lightsaber, 128, 13),
    OQS_GROUP_ENTRY(saber, saber, saber, 192, 14),
    OQS_GROUP_ENTRY_ECP(saber, saber, saber, 192, 14),
    OQS_GROUP_ENTRY_ECX(saber, saber, saber, 192, 14),
    OQS_GROUP_ENTRY(firesaber, firesaber, firesaber, 256, 15),
    OQS_GROUP_ENTRY_ECP(firesaber, firesaber, firesaber, 256, 15),
    OQS_GROUP_ENTRY(sidhp434, sidhp434, sidhp434, 128, 16),
    OQS_GROUP_ENTRY_ECP(sidhp434, sidhp434, sidhp434, 128, 16),
    OQS_GROUP_ENTRY_ECX(sidhp434, sidhp434, sidhp434, 128, 16),
    OQS_GROUP_ENTRY(sidhp503, sidhp503, sidhp503, 128, 17),
    OQS_GROUP_ENTRY_ECP(sidhp503, sidhp503, sidhp503, 128, 17),
    OQS_GROUP_ENTRY_ECX(sidhp503, sidhp503, sidhp503, 128, 17),
    OQS_GROUP_ENTRY(sidhp610, sidhp610, sidhp610, 192, 18),
    OQS_GROUP_ENTRY_ECP(sidhp610, sidhp610, sidhp610, 192, 18),
    OQS_GROUP_ENTRY_ECX(sidhp610, sidhp610, sidhp610, 192, 18),
    OQS_GROUP_ENTRY(sidhp751, sidhp751, sidhp751, 256, 19),
    OQS_GROUP_ENTRY_ECP(sidhp751, sidhp751, sidhp751, 256, 19),
    OQS_GROUP_ENTRY(sikep434, sikep434, sikep434, 128, 20),
    OQS_GROUP_ENTRY_ECP(sikep434, sikep434, sikep434, 128, 20),
    OQS_GROUP_ENTRY_ECX(sikep434, sikep434, sikep434, 128, 20),
    OQS_GROUP_ENTRY(sikep503, sikep503, sikep503, 128, 21),
    OQS_GROUP_ENTRY_ECP(sikep503, sikep503, sikep503, 128, 21),
    OQS_GROUP_ENTRY_ECX(sikep503, sikep503, sikep503, 128, 21),
    OQS_GROUP_ENTRY(sikep610, sikep610, sikep610, 192, 22),
    OQS_GROUP_ENTRY_ECP(sikep610, sikep610, sikep610, 192, 22),
    OQS_GROUP_ENTRY_ECX(sikep610, sikep610, sikep610, 192, 22),
    OQS_GROUP_ENTRY(sikep751, sikep751, sikep751, 256, 23),
    ...
    OQS_GROUP_ENTRY_ECP(kyber90s512, kyber90s512, kyber90s512, 128, 26),
    OQS_GROUP_ENTRY_ECX(kyber90s512, kyber90s512, kyber90s512, 128, 26),
    OQS_GROUP_ENTRY(kyber90s768, kyber90s768, kyber90s768, 192, 27),
    OQS_GROUP_ENTRY_ECP(kyber90s768, kyber90s768, kyber90s768, 192, 27),
    OQS_GROUP_ENTRY_ECX(kyber90s768, kyber90s768, kyber90s768, 192, 27),
    OQS_GROUP_ENTRY(kyber90s1024, kyber90s1024, kyber90s1024, 256, 28),
    OQS_GROUP_ENTRY_ECP(kyber90s1024, kyber90s1024, kyber90s1024, 256, 28),
    OQS_GROUP_ENTRY(hqc128, hqc128, hqc128, 128, 29),
    OQS_GROUP_ENTRY_ECP(hqc128, hqc128, hqc128, 128, 29),
    OQS_GROUP_ENTRY_ECX(hqc128, hqc128, hqc128, 128, 29),
    OQS_GROUP_ENTRY(hqc192, hqc192, hqc192, 192, 30),
    OQS_GROUP_ENTRY_ECP(hqc192, hqc192, hqc192, 192, 30),
    OQS_GROUP_ENTRY_ECX(hqc192, hqc192, hqc192, 192, 30),
    OQS_GROUP_ENTRY(hqc256, hqc256, hqc256, 256, 31),
    OQS_GROUP_ENTRY_ECP(hqc256, hqc256, hqc256, 256, 31),
