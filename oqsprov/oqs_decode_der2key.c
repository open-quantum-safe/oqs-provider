...
MAKE_DECODER("sphincsharaka128fsimple", sphincsharaka128fsimple, oqsx, PrivateKeyInfo);
MAKE_DECODER("sphincsharaka128fsimple", sphincsharaka128fsimple, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("p256_sphincsharaka128fsimple", p256_sphincsharaka128fsimple, oqsx, PrivateKeyInfo);
MAKE_DECODER("p256_sphincsharaka128fsimple", p256_sphincsharaka128fsimple, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER("rsa3072_sphincsharaka128fsimple", rsa3072_sphincsharaka128fsimple, oqsx, PrivateKeyInfo);
MAKE_DECODER("rsa3072_sphincsharaka128fsimple", rsa3072_sphincsharaka128fsimple, oqsx, SubjectPublicKeyInfo);
