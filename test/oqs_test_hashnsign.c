...
static const EVP_MD* get_digest_for_algorithm(const char* alg_name) {
    ...
    if (strstr(lowercase_alg_name, "sha256")) md = EVP_sha256();
    else if (strstr(lowercase_alg_name, "sha384")) md = EVP_sha384();
    else if (strstr(lowercase_alg_name, "sha512")) md = EVP_sha512();
    else if (strstr(lowercase_alg_name, "sha3-256")) md = EVP_sha3_256();
    else if (strstr(lowercase_alg_name, "sha3-384")) md = EVP_sha3_384();
    else if (strstr(lowercase_alg_name, "sha3-512")) md = EVP_sha3_512();
    else if (strstr(lowercase_alg_name, "shake128")) md = EVP_shake128();
    else if (strstr(lowercase_alg_name, "shake256")) md = EVP_shake256();
