...
static OQS_SIGALG_CONSTANTS oqs_sigalg_list[] = {
    ...
    {0xfed0, 128, TLS1_3_VERSION, 0}, {0xfed3, 128, TLS1_3_VERSION, 0},
    {0xfed4, 128, TLS1_3_VERSION, 0}, {0xfee1, 128, TLS1_3_VERSION, 0},
    {0xfee2, 128, TLS1_3_VERSION, 0}, {0xfee3, 128, TLS1_3_VERSION, 0},
    {0xfee4, 128, TLS1_3_VERSION, 0}, {0xfee5, 128, TLS1_3_VERSION, 0},
    {0xfed1, 192, TLS1_3_VERSION, 0}, {0xfed5, 192, TLS1_3_VERSION, 0},
    {0xfee6, 192, TLS1_3_VERSION, 0}, {0xfee7, 192, TLS1_3_VERSION, 0},
    {0xfee8, 192, TLS1_3_VERSION, 0}, {0xfee9, 192, TLS1_3_VERSION, 0},
    {0xfeea, 192, TLS1_3_VERSION, 0}, {0xfed2, 256, TLS1_3_VERSION, 0},
    {0xfed6, 256, TLS1_3_VERSION, 0}, {0xfeeb, 256, TLS1_3_VERSION, 0},
    {0xfeec, 256, TLS1_3_VERSION, 0}, {0xfeed, 256, TLS1_3_VERSION, 0},
...
#    ifdef OQS_ENABLE_SIG_ml_dsa_44
    OQS_SIGALG_ENTRY(mldsa44, mldsa44, mldsa44, "1.3.6.1.4.1.2.267.12.4.4", 0),
...
#    ifdef OQS_ENABLE_SIG_ml_dsa_65
    OQS_SIGALG_ENTRY(mldsa65, mldsa65, mldsa65, "1.3.6.1.4.1.2.267.12.6.5", 8),
...
#    ifdef OQS_ENABLE_SIG_ml_dsa_87
    OQS_SIGALG_ENTRY(mldsa87, mldsa87, mldsa87, "1.3.6.1.4.1.2.267.12.8.7", 15),
