...
static oqs_nid_name_t nid_names[NID_TABLE_LEN] = {
    ...
    {0, "p521_snova2965", OQS_SIG_alg_snova_SNOVA_29_6_5, KEY_TYPE_HYB_SIG,
     256},
    {0, "slhdsapuresha2128s", OQS_SIG_alg_slh_dsa_pure_sha2_128s, KEY_TYPE_SIG,
     128},
    {0, "slhdsapuresha2128f", OQS_SIG_alg_slh_dsa_pure_sha2_128f, KEY_TYPE_SIG,
     128},
    {0, "slhdsapuresha2192s", OQS_SIG_alg_slh_dsa_pure_sha2_192s, KEY_TYPE_SIG,
     192},
    {0, "slhdsapuresha2192f", OQS_SIG_alg_slh_dsa_pure_sha2_192f, KEY_TYPE_SIG,
     192},
    {0, "slhdsapuresha2256s", OQS_SIG_alg_slh_dsa_pure_sha2_256s, KEY_TYPE_SIG,
     256},
    {0, "slhdsapuresha2256f", OQS_SIG_alg_slh_dsa_pure_sha2_256f, KEY_TYPE_SIG,
     256},
    {0, "slhdsapureshake128s", OQS_SIG_alg_slh_dsa_pure_shake_128s,
     KEY_TYPE_SIG, 128},
    {0, "slhdsapureshake128f", OQS_SIG_alg_slh_dsa_pure_shake_128f,
     KEY_TYPE_SIG, 128},
    {0, "slhdsapureshake192s", OQS_SIG_alg_slh_dsa_pure_shake_192s,
     KEY_TYPE_SIG, 192},
    {0, "slhdsapureshake192f", OQS_SIG_alg_slh_dsa_pure_shake_192f,
     KEY_TYPE_SIG, 192},
    {0, "slhdsapureshake256s", OQS_SIG_alg_slh_dsa_pure_shake_256s,
     KEY_TYPE_SIG, 256},
    {0, "slhdsapureshake256f", OQS_SIG_alg_slh_dsa_pure_shake_256f,
     KEY_TYPE_SIG, 256},
