...
static void *slhdsapuresha2128s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_128s,
                        "slhdsapuresha2128s", KEY_TYPE_SIG, NULL, 128, 55, 0);
}

static void *slhdsapuresha2128s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_128s,
                         "slhdsapuresha2128s", 0, 128, 55, 0);
}
static void *slhdsapuresha2128f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_128f,
                        "slhdsapuresha2128f", KEY_TYPE_SIG, NULL, 128, 56, 0);
}

static void *slhdsapuresha2128f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_128f,
                         "slhdsapuresha2128f", 0, 128, 56, 0);
}
static void *slhdsapuresha2192s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_192s,
                        "slhdsapuresha2192s", KEY_TYPE_SIG, NULL, 192, 57, 0);
}

static void *slhdsapuresha2192s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_192s,
                         "slhdsapuresha2192s", 0, 192, 57, 0);
}
static void *slhdsapuresha2192f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_192f,
                        "slhdsapuresha2192f", KEY_TYPE_SIG, NULL, 192, 58, 0);
}

static void *slhdsapuresha2192f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_192f,
                         "slhdsapuresha2192f", 0, 192, 58, 0);
}
static void *slhdsapuresha2256s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_256s,
                        "slhdsapuresha2256s", KEY_TYPE_SIG, NULL, 256, 59, 0);
}

static void *slhdsapuresha2256s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_256s,
                         "slhdsapuresha2256s", 0, 256, 59, 0);
}
static void *slhdsapuresha2256f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_sha2_256f,
                        "slhdsapuresha2256f", KEY_TYPE_SIG, NULL, 256, 60, 0);
}

static void *slhdsapuresha2256f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection, OQS_SIG_alg_slh_dsa_pure_sha2_256f,
                         "slhdsapuresha2256f", 0, 256, 60, 0);
}
static void *slhdsapureshake128s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_128s,
                        "slhdsapureshake128s", KEY_TYPE_SIG, NULL, 128, 61, 0);
}

static void *slhdsapureshake128s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_128s,
                         "slhdsapureshake128s", 0, 128, 61, 0);
}
static void *slhdsapureshake128f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_128f,
                        "slhdsapureshake128f", KEY_TYPE_SIG, NULL, 128, 62, 0);
}

static void *slhdsapureshake128f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_128f,
                         "slhdsapureshake128f", 0, 128, 62, 0);
}
static void *slhdsapureshake192s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_192s,
                        "slhdsapureshake192s", KEY_TYPE_SIG, NULL, 192, 63, 0);
}

static void *slhdsapureshake192s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_192s,
                         "slhdsapureshake192s", 0, 192, 63, 0);
}
static void *slhdsapureshake192f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_192f,
                        "slhdsapureshake192f", KEY_TYPE_SIG, NULL, 192, 64, 0);
}

static void *slhdsapureshake192f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_192f,
                         "slhdsapureshake192f", 0, 192, 64, 0);
}
static void *slhdsapureshake256s_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_256s,
                        "slhdsapureshake256s", KEY_TYPE_SIG, NULL, 256, 65, 0);
}

static void *slhdsapureshake256s_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_256s,
                         "slhdsapureshake256s", 0, 256, 65, 0);
}
static void *slhdsapureshake256f_new_key(void *provctx) {
    return oqsx_key_new(PROV_OQS_LIBCTX_OF(provctx),
                        OQS_SIG_alg_slh_dsa_pure_shake_256f,
                        "slhdsapureshake256f", KEY_TYPE_SIG, NULL, 256, 66, 0);
}

static void *slhdsapureshake256f_gen_init(void *provctx, int selection) {
    return oqsx_gen_init(provctx, selection,
                         OQS_SIG_alg_slh_dsa_pure_shake_256f,
                         "slhdsapureshake256f", 0, 256, 66, 0);
}
...
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2128s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2128f)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2192s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2192f)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2256s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapuresha2256f)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake128s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake128f)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake192s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake192f)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake256s)
MAKE_SIG_KEYMGMT_FUNCTIONS(slhdsapureshake256f)
