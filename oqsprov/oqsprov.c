...
"1.3.9999.99.34", "p384_mlkem768",
"1.3.9999.99.9", "x448_mlkem768",
"1.3.9999.99.10", "x25519_mlkem768",
"1.3.9999.99.11", "p256_mlkem768",
"1.3.6.1.4.1.22554.5.6.3", "mlkem1024",
"1.3.9999.99.35", "p521_mlkem1024",
"1.3.6.1.4.1.42235.6", "p384_mlkem1024",
"1.3.9999.99.37", "bikel1",
"1.3.9999.99.36", "p256_bikel1",
"1.3.9999.99.12", "x25519_bikel1",
"1.3.9999.99.39", "bikel3",
"1.3.9999.99.38", "p384_bikel3",
"1.3.9999.99.13", "x448_bikel3",
"1.3.9999.99.41", "bikel5",
"1.3.9999.99.40", "p521_bikel5",
"1.3.9999.99.43", "hqc128",
"1.3.9999.99.42", "p256_hqc128",
"1.3.9999.99.14", "x25519_hqc128",
"1.3.9999.99.45", "hqc192",
"1.3.9999.99.44", "p384_hqc192",
"1.3.9999.99.15", "x448_hqc192",
"1.3.9999.99.47", "hqc256",
"1.3.9999.99.46", "p521_hqc256",
...
if (getenv("OQS_OID_MLKEM512")) oqs_oid_alg_list[52] = getenv("OQS_OID_MLKEM512");

if (getenv("OQS_OID_P256_MLKEM512")) oqs_oid_alg_list[54] = getenv("OQS_OID_P256_MLKEM512");
if (getenv("OQS_OID_X25519_MLKEM512")) oqs_oid_alg_list[56] = getenv("OQS_OID_X25519_MLKEM512");
if (getenv("OQS_OID_MLKEM768")) oqs_oid_alg_list[58] = getenv("OQS_OID_MLKEM768");

if (getenv("OQS_OID_P384_MLKEM768")) oqs_oid_alg_list[60] = getenv("OQS_OID_P384_MLKEM768");
if (getenv("OQS_OID_X448_MLKEM768")) oqs_oid_alg_list[62] = getenv("OQS_OID_X448_MLKEM768");
if (getenv("OQS_OID_X25519_MLKEM768")) oqs_oid_alg_list[64] = getenv("OQS_OID_X25519_MLKEM768");
if (getenv("OQS_OID_P256_MLKEM768")) oqs_oid_alg_list[66] = getenv("OQS_OID_P256_MLKEM768");
if (getenv("OQS_OID_MLKEM1024")) oqs_oid_alg_list[68] = getenv("OQS_OID_MLKEM1024");

if (getenv("OQS_OID_P521_MLKEM1024")) oqs_oid_alg_list[70] = getenv("OQS_OID_P521_MLKEM1024");
if (getenv("OQS_OID_P384_MLKEM1024")) oqs_oid_alg_list[72] = getenv("OQS_OID_P384_MLKEM1024");
if (getenv("OQS_OID_BIKEL1")) oqs_oid_alg_list[74] = getenv("OQS_OID_BIKEL1");

if (getenv("OQS_OID_P256_BIKEL1")) oqs_oid_alg_list[76] = getenv("OQS_OID_P256_BIKEL1");
if (getenv("OQS_OID_X25519_BIKEL1")) oqs_oid_alg_list[78] = getenv("OQS_OID_X25519_BIKEL1");
if (getenv("OQS_OID_BIKEL3")) oqs_oid_alg_list[80] = getenv("OQS_OID_BIKEL3");

if (getenv("OQS_OID_P384_BIKEL3")) oqs_oid_alg_list[82] = getenv("OQS_OID_P384_BIKEL3");
if (getenv("OQS_OID_X448_BIKEL3")) oqs_oid_alg_list[84] = getenv("OQS_OID_X448_BIKEL3");
if (getenv("OQS_OID_BIKEL5")) oqs_oid_alg_list[86] = getenv("OQS_OID_BIKEL5");

if (getenv("OQS_OID_P521_BIKEL5")) oqs_oid_alg_list[88] = getenv("OQS_OID_P521_BIKEL5");
if (getenv("OQS_OID_HQC128")) oqs_oid_alg_list[90] = getenv("OQS_OID_HQC128");

if (getenv("OQS_OID_P256_HQC128")) oqs_oid_alg_list[92] = getenv("OQS_OID_P256_HQC128");
if (getenv("OQS_OID_X25519_HQC128")) oqs_oid_alg_list[94] = getenv("OQS_OID_X25519_HQC128");
if (getenv("OQS_OID_HQC192")) oqs_oid_alg_list[96] = getenv("OQS_OID_HQC192");

if (getenv("OQS_OID_P384_HQC192")) oqs_oid_alg_list[98] = getenv("OQS_OID_P384_HQC192");
if (getenv("OQS_OID_X448_HQC192")) oqs_oid_alg_list[100] = getenv("OQS_OID_X448_HQC192");
if (getenv("OQS_OID_HQC256")) oqs_oid_alg_list[102] = getenv("OQS_OID_HQC256");

if (getenv("OQS_OID_P521_HQC256")) oqs_oid_alg_list[104] = getenv("OQS_OID_P521_HQC256");
...
#define OQS_KEMOID_CNT 0
   ...
   if (getenv("OQS_OID_MLDSA44")) oqs_oid_alg_list[14+OQS_KEMOID_CNT] = getenv("OQS_OID_MLDSA44");
   if (getenv("OQS_OID_P256_MLDSA44")) oqs_oid_alg_list[16+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_MLDSA44");
   if (getenv("OQS_OID_RSA3072_MLDSA44")) oqs_oid_alg_list[18+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_MLDSA44");
   if (getenv("OQS_OID_MLDSA65")) oqs_oid_alg_list[20+OQS_KEMOID_CNT] = getenv("OQS_OID_MLDSA65");
   if (getenv("OQS_OID_P384_MLDSA65")) oqs_oid_alg_list[22+OQS_KEMOID_CNT] = getenv("OQS_OID_P384_MLDSA65");
   if (getenv("OQS_OID_MLDSA87")) oqs_oid_alg_list[24+OQS_KEMOID_CNT] = getenv("OQS_OID_MLDSA87");
   if (getenv("OQS_OID_P521_MLDSA87")) oqs_oid_alg_list[26+OQS_KEMOID_CNT] = getenv("OQS_OID_P521_MLDSA87");
   if (getenv("OQS_OID_FALCON512")) oqs_oid_alg_list[28+OQS_KEMOID_CNT] = getenv("OQS_OID_FALCON512");
   if (getenv("OQS_OID_P256_FALCON512")) oqs_oid_alg_list[30+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_FALCON512");
   if (getenv("OQS_OID_RSA3072_FALCON512")) oqs_oid_alg_list[32+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_FALCON512");
   if (getenv("OQS_OID_FALCONPADDED512")) oqs_oid_alg_list[34+OQS_KEMOID_CNT] = getenv("OQS_OID_FALCONPADDED512");
   if (getenv("OQS_OID_P256_FALCONPADDED512")) oqs_oid_alg_list[36+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_FALCONPADDED512");
   if (getenv("OQS_OID_RSA3072_FALCONPADDED512")) oqs_oid_alg_list[38+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_FALCONPADDED512");
   if (getenv("OQS_OID_FALCON1024")) oqs_oid_alg_list[40+OQS_KEMOID_CNT] = getenv("OQS_OID_FALCON1024");
   if (getenv("OQS_OID_P521_FALCON1024")) oqs_oid_alg_list[42+OQS_KEMOID_CNT] = getenv("OQS_OID_P521_FALCON1024");
   if (getenv("OQS_OID_FALCONPADDED1024")) oqs_oid_alg_list[44+OQS_KEMOID_CNT] = getenv("OQS_OID_FALCONPADDED1024");
   if (getenv("OQS_OID_P521_FALCONPADDED1024")) oqs_oid_alg_list[46+OQS_KEMOID_CNT] = getenv("OQS_OID_P521_FALCONPADDED1024");
   if (getenv("OQS_OID_SPHINCSSHA2128FSIMPLE")) oqs_oid_alg_list[48+OQS_KEMOID_CNT] = getenv("OQS_OID_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_OID_P256_SPHINCSSHA2128FSIMPLE")) oqs_oid_alg_list[50+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_OID_RSA3072_SPHINCSSHA2128FSIMPLE")) oqs_oid_alg_list[52+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_OID_SPHINCSSHA2128SSIMPLE")) oqs_oid_alg_list[54+OQS_KEMOID_CNT] = getenv("OQS_OID_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_OID_P256_SPHINCSSHA2128SSIMPLE")) oqs_oid_alg_list[56+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_OID_RSA3072_SPHINCSSHA2128SSIMPLE")) oqs_oid_alg_list[58+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_OID_SPHINCSSHA2192FSIMPLE")) oqs_oid_alg_list[60+OQS_KEMOID_CNT] = getenv("OQS_OID_SPHINCSSHA2192FSIMPLE");
   if (getenv("OQS_OID_P384_SPHINCSSHA2192FSIMPLE")) oqs_oid_alg_list[62+OQS_KEMOID_CNT] = getenv("OQS_OID_P384_SPHINCSSHA2192FSIMPLE");
   if (getenv("OQS_OID_SPHINCSSHAKE128FSIMPLE")) oqs_oid_alg_list[64+OQS_KEMOID_CNT] = getenv("OQS_OID_SPHINCSSHAKE128FSIMPLE");
   if (getenv("OQS_OID_P256_SPHINCSSHAKE128FSIMPLE")) oqs_oid_alg_list[66+OQS_KEMOID_CNT] = getenv("OQS_OID_P256_SPHINCSSHAKE128FSIMPLE");
   if (getenv("OQS_OID_RSA3072_SPHINCSSHAKE128FSIMPLE")) oqs_oid_alg_list[68+OQS_KEMOID_CNT] = getenv("OQS_OID_RSA3072_SPHINCSSHAKE128FSIMPLE");
...
int oqs_patch_encodings(void)
{
   ...
   if (getenv("OQS_ENCODING_MLDSA44")) oqs_alg_encoding_list[14] = getenv("OQS_ENCODING_MLDSA44");
   if (getenv("OQS_ENCODING_MLDSA44_ALGNAME")) oqs_alg_encoding_list[15] = getenv("OQS_ENCODING_MLDSA44_ALGNAME");
   if (getenv("OQS_ENCODING_P256_MLDSA44")) oqs_alg_encoding_list[16] = getenv("OQS_ENCODING_P256_MLDSA44");
   if (getenv("OQS_ENCODING_P256_MLDSA44_ALGNAME")) oqs_alg_encoding_list[17] = getenv("OQS_ENCODING_P256_MLDSA44_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_MLDSA44")) oqs_alg_encoding_list[18] = getenv("OQS_ENCODING_RSA3072_MLDSA44");
   if (getenv("OQS_ENCODING_RSA3072_MLDSA44_ALGNAME")) oqs_alg_encoding_list[19] = getenv("OQS_ENCODING_RSA3072_MLDSA44_ALGNAME");
   if (getenv("OQS_ENCODING_MLDSA65")) oqs_alg_encoding_list[20] = getenv("OQS_ENCODING_MLDSA65");
   if (getenv("OQS_ENCODING_MLDSA65_ALGNAME")) oqs_alg_encoding_list[21] = getenv("OQS_ENCODING_MLDSA65_ALGNAME");
   if (getenv("OQS_ENCODING_P384_MLDSA65")) oqs_alg_encoding_list[22] = getenv("OQS_ENCODING_P384_MLDSA65");
   if (getenv("OQS_ENCODING_P384_MLDSA65_ALGNAME")) oqs_alg_encoding_list[23] = getenv("OQS_ENCODING_P384_MLDSA65_ALGNAME");
   if (getenv("OQS_ENCODING_MLDSA87")) oqs_alg_encoding_list[24] = getenv("OQS_ENCODING_MLDSA87");
   if (getenv("OQS_ENCODING_MLDSA87_ALGNAME")) oqs_alg_encoding_list[25] = getenv("OQS_ENCODING_MLDSA87_ALGNAME");
   if (getenv("OQS_ENCODING_P521_MLDSA87")) oqs_alg_encoding_list[26] = getenv("OQS_ENCODING_P521_MLDSA87");
   if (getenv("OQS_ENCODING_P521_MLDSA87_ALGNAME")) oqs_alg_encoding_list[27] = getenv("OQS_ENCODING_P521_MLDSA87_ALGNAME");
   if (getenv("OQS_ENCODING_FALCON512")) oqs_alg_encoding_list[28] = getenv("OQS_ENCODING_FALCON512");
   if (getenv("OQS_ENCODING_FALCON512_ALGNAME")) oqs_alg_encoding_list[29] = getenv("OQS_ENCODING_FALCON512_ALGNAME");
   if (getenv("OQS_ENCODING_P256_FALCON512")) oqs_alg_encoding_list[30] = getenv("OQS_ENCODING_P256_FALCON512");
   if (getenv("OQS_ENCODING_P256_FALCON512_ALGNAME")) oqs_alg_encoding_list[31] = getenv("OQS_ENCODING_P256_FALCON512_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_FALCON512")) oqs_alg_encoding_list[32] = getenv("OQS_ENCODING_RSA3072_FALCON512");
   if (getenv("OQS_ENCODING_RSA3072_FALCON512_ALGNAME")) oqs_alg_encoding_list[33] = getenv("OQS_ENCODING_RSA3072_FALCON512_ALGNAME");
   if (getenv("OQS_ENCODING_FALCONPADDED512")) oqs_alg_encoding_list[34] = getenv("OQS_ENCODING_FALCONPADDED512");
   if (getenv("OQS_ENCODING_FALCONPADDED512_ALGNAME")) oqs_alg_encoding_list[35] = getenv("OQS_ENCODING_FALCONPADDED512_ALGNAME");
   if (getenv("OQS_ENCODING_P256_FALCONPADDED512")) oqs_alg_encoding_list[36] = getenv("OQS_ENCODING_P256_FALCONPADDED512");
   if (getenv("OQS_ENCODING_P256_FALCONPADDED512_ALGNAME")) oqs_alg_encoding_list[37] = getenv("OQS_ENCODING_P256_FALCONPADDED512_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_FALCONPADDED512")) oqs_alg_encoding_list[38] = getenv("OQS_ENCODING_RSA3072_FALCONPADDED512");
   if (getenv("OQS_ENCODING_RSA3072_FALCONPADDED512_ALGNAME")) oqs_alg_encoding_list[39] = getenv("OQS_ENCODING_RSA3072_FALCONPADDED512_ALGNAME");
   if (getenv("OQS_ENCODING_FALCON1024")) oqs_alg_encoding_list[40] = getenv("OQS_ENCODING_FALCON1024");
   if (getenv("OQS_ENCODING_FALCON1024_ALGNAME")) oqs_alg_encoding_list[41] = getenv("OQS_ENCODING_FALCON1024_ALGNAME");
   if (getenv("OQS_ENCODING_P521_FALCON1024")) oqs_alg_encoding_list[42] = getenv("OQS_ENCODING_P521_FALCON1024");
   if (getenv("OQS_ENCODING_P521_FALCON1024_ALGNAME")) oqs_alg_encoding_list[43] = getenv("OQS_ENCODING_P521_FALCON1024_ALGNAME");
   if (getenv("OQS_ENCODING_FALCONPADDED1024")) oqs_alg_encoding_list[44] = getenv("OQS_ENCODING_FALCONPADDED1024");
   if (getenv("OQS_ENCODING_FALCONPADDED1024_ALGNAME")) oqs_alg_encoding_list[45] = getenv("OQS_ENCODING_FALCONPADDED1024_ALGNAME");
   if (getenv("OQS_ENCODING_P521_FALCONPADDED1024")) oqs_alg_encoding_list[46] = getenv("OQS_ENCODING_P521_FALCONPADDED1024");
   if (getenv("OQS_ENCODING_P521_FALCONPADDED1024_ALGNAME")) oqs_alg_encoding_list[47] = getenv("OQS_ENCODING_P521_FALCONPADDED1024_ALGNAME");
   if (getenv("OQS_ENCODING_SPHINCSSHA2128FSIMPLE")) oqs_alg_encoding_list[48] = getenv("OQS_ENCODING_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_ENCODING_SPHINCSSHA2128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[49] = getenv("OQS_ENCODING_SPHINCSSHA2128FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHA2128FSIMPLE")) oqs_alg_encoding_list[50] = getenv("OQS_ENCODING_P256_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHA2128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[51] = getenv("OQS_ENCODING_P256_SPHINCSSHA2128FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128FSIMPLE")) oqs_alg_encoding_list[52] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128FSIMPLE");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[53] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_SPHINCSSHA2128SSIMPLE")) oqs_alg_encoding_list[54] = getenv("OQS_ENCODING_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_ENCODING_SPHINCSSHA2128SSIMPLE_ALGNAME")) oqs_alg_encoding_list[55] = getenv("OQS_ENCODING_SPHINCSSHA2128SSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHA2128SSIMPLE")) oqs_alg_encoding_list[56] = getenv("OQS_ENCODING_P256_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHA2128SSIMPLE_ALGNAME")) oqs_alg_encoding_list[57] = getenv("OQS_ENCODING_P256_SPHINCSSHA2128SSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128SSIMPLE")) oqs_alg_encoding_list[58] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128SSIMPLE");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128SSIMPLE_ALGNAME")) oqs_alg_encoding_list[59] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHA2128SSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_SPHINCSSHA2192FSIMPLE")) oqs_alg_encoding_list[60] = getenv("OQS_ENCODING_SPHINCSSHA2192FSIMPLE");
   if (getenv("OQS_ENCODING_SPHINCSSHA2192FSIMPLE_ALGNAME")) oqs_alg_encoding_list[61] = getenv("OQS_ENCODING_SPHINCSSHA2192FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_P384_SPHINCSSHA2192FSIMPLE")) oqs_alg_encoding_list[62] = getenv("OQS_ENCODING_P384_SPHINCSSHA2192FSIMPLE");
   if (getenv("OQS_ENCODING_P384_SPHINCSSHA2192FSIMPLE_ALGNAME")) oqs_alg_encoding_list[63] = getenv("OQS_ENCODING_P384_SPHINCSSHA2192FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_SPHINCSSHAKE128FSIMPLE")) oqs_alg_encoding_list[64] = getenv("OQS_ENCODING_SPHINCSSHAKE128FSIMPLE");
   if (getenv("OQS_ENCODING_SPHINCSSHAKE128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[65] = getenv("OQS_ENCODING_SPHINCSSHAKE128FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHAKE128FSIMPLE")) oqs_alg_encoding_list[66] = getenv("OQS_ENCODING_P256_SPHINCSSHAKE128FSIMPLE");
   if (getenv("OQS_ENCODING_P256_SPHINCSSHAKE128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[67] = getenv("OQS_ENCODING_P256_SPHINCSSHAKE128FSIMPLE_ALGNAME");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHAKE128FSIMPLE")) oqs_alg_encoding_list[68] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHAKE128FSIMPLE");
   if (getenv("OQS_ENCODING_RSA3072_SPHINCSSHAKE128FSIMPLE_ALGNAME")) oqs_alg_encoding_list[69] = getenv("OQS_ENCODING_RSA3072_SPHINCSSHAKE128FSIMPLE_ALGNAME");
